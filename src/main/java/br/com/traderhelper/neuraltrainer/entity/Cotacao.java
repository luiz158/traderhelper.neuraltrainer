package br.com.traderhelper.neuraltrainer.entity;
...
public class Cotacao implements Serializable {
    ...
    public String toString() {
        return "Cotacao{" +
                ...
                ", totalNegociosEfetuados=" + totalNegociosEfetuados +
                ", totalTitulosNegociados=" + totalTitulosNegociados +
                ", volumeTitulosNegociados=" + volumeTitulosNegociados +
                ", precoExercicio=" + precoExercicio +
                ", prazoDiasMercadoTermo=" + prazoDiasMercadoTermo +
                ", moedaReferencia='" + moedaReferencia + '\'' +
                ", dataVencimentoOpcoes='" + dataVencimentoOpcoes + '\'' +
                ", fatorCotacao='" + fatorCotacao + '\'' +
                ", precoPontosOpcoes=" + precoPontosOpcoes +
                ", variacaoPercentualDiaAnterior=" + variacaoPercentualDiaAnterior +
                ", variacaoCentavosDiaAnterior=" + variacaoCentavosDiaAnterior +
                '}';
    }
}
